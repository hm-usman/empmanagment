                 ...
                 <?php foreach ($alpp_emp as $emp): ?>
                    ...
                    <td><div class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                              ...
                              <li role="presentation"><a href="" data-toggle="modal" data-target="#edit<?php echo $emp['emp_id'];?>"><span class="glyphicon glyphicon-edit "></span>Edit</a></li>
...
<?php      
                    ...
                    ?>
  <div class="modal fade" id="edit<?php echo $emp['emp_id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <div class="modal-body">
            <div class="form-horizontal" role="form">  
                <div class="form-group">
                    ...
                    <div class="col-sm-4">          
                        <input type="text" class="form-control" value=" <?php echo $emp['emp_file'] ?>" placeholder="Ficha" name="emp_file">
                    </div>
                    <label class="control-label col-sm-2">Nombre</label>
                    <div class="col-sm-4">          
                        <input type="text" class="form-control" value=" <?php echo $emp['emp_name'] ?>" placeholder="Nombre" name="emp_name">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2">RUT</label>                     
                    <div class="col-sm-4">
                         <input type="text" class="form-control" value=" <?php echo $emp['emp_cellnum'] ?>" placeholder="RUT" name="emp_cellnum">
                    </div>
                    <label class="control-label col-sm-2">Department</label>
                    <div class="col-sm-4">
                        <select name="emp_department" class="form-control">
                            <option value="<?php echo $emp['emp_department'];?>"><?php echo $emp['emp_department'];?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" id="emp_current_contract" class="form-control" value=" <?php echo date("d-m-Y",strtotime($emp['emp_current_contract'])); ?>" onchange="" placeholder="Contrato Actual" name="emp_current_contract">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2">Email</label>                     
                    <div class="col-sm-4">
                        <input type="email" name="emp_email" class="form-control"  value=" <?php echo $emp['emp_email'] ?>" placeholder="Enter email">
                    </div>
                    <label class="control-label col-sm-2">Password</label>                     
                    <div class="col-sm-3">
                        <input type="password" name="emp_password" class="form-control" value=" <?php echo $emp['emp_password'] ?>"  placeholder="Password">
                    </div>
                </div>        
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-4 col-sm-4">
                        <button type="submit" name="submit" class="btn btn-small btn-block  btn-success">Update</button>
                    </div>
                </div>       
        </div>
       </div>
